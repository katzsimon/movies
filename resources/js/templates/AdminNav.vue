    ...
    <nav class="bg-gray-800">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <inertia-link :href="$route('admin.movies.index')" class="btn-nav" v-if="$page.props.authed">Movies</inertia-link>
                            <inertia-link :href="$route('admin.cinemas.index')" class="btn-nav" v-if="$page.props.authed">Cinemas</inertia-link>
                            <inertia-link :href="$route('admin.screenings.index')" class="btn-nav" v-if="$page.props.authed">Screenings</inertia-link>
                            <inertia-link :href="$route('admin.bookings.index')" class="btn-nav" v-if="$page.props.authed">Bookings</inertia-link>
        ...
        <div class="md:hidden" id="mobile-menu"  v-show="mobileMenuOpen">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                ...
                <inertia-link :href="$route('admin.movies.index')" class="btn-nav-mobile" v-if="$page.props.authed">Movies</inertia-link>
                <inertia-link :href="$route('admin.cinemas.index')" class="btn-nav-mobile" v-if="$page.props.authed">Cinemas</inertia-link>
                <inertia-link :href="$route('admin.screenings.index')" class="btn-nav-mobile" v-if="$page.props.authed">Screenings</inertia-link>
                <inertia-link :href="$route('admin.bookings.index')" class="btn-nav-mobile" v-if="$page.props.authed">Bookings</inertia-link>
